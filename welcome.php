...
function load_javascript($applic)
{
    ...
    rw_line('<script type="text/javascript" src="https://d3js.org/d3.v5.min.js"></script>');
    rw_line('<script type="text/javascript" src="https://d3js.org/d3-array.v1.min.js"></script>');
    rw_line('<script type="text/javascript" src="https://d3js.org/d3-geo.v1.min.js"></script>');
    rw_line('<script type="text/javascript" src="https://d3js.org/d3-geo-projection.v2.min.js"></script>');
